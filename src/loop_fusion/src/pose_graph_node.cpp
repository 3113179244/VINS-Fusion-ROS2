...
int main(int argc, char **argv)
{
    ...
    string vocabulary_file = "/home/wzj/VINS-Fusion-ROS2/src/support_files/brief_k10L6.bin";
    cout << "vocabulary_file" << vocabulary_file << endl;
    posegraph.loadVocabulary(vocabulary_file);

    BRIEF_PATTERN_FILE = "/home/wzj/VINS-Fusion-ROS2/src/support_files/brief_pattern.yml";
